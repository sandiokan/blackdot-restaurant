...
export default function CalendarPage() {
  const { reservations, lunchCovers, dinnerCovers, setModalOpen } = useAppData();
  ...
  return <div className="page calendar-page">
    ...
    <Panel className="day-schedule">
      ...
      <div className="service-summary"><ServiceProgress label="PRANZO · 12:00 – 15:00" used={lunch} /><ServiceProgress label="CENA · 19:00 – 23:00" used={dinner} /></div>
